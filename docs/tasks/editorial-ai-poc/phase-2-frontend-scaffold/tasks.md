...
- [ ] **T1** `[AGENT]` Write `frontend/package.json`
...
- [ ] **T2** `[AGENT]` Write `frontend/vite.config.js`
...
- [ ] **T3** `[AGENT]` Write `frontend/index.html`
...
- [ ] **T4** `[AGENT]` Create `frontend/src/` structure with stubs
...
- [ ] **T5** `[AGENT]` Write `frontend/Dockerfile`
