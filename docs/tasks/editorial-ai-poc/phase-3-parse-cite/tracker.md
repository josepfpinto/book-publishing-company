...
| Task | Status   | Note |
| ---- | -------- | ---- |
| T1   | done     | ingestion.py: 47 LW chapters, 61 P&P chapters, all assertions pass |
| T2   | done     | citations.py: all 4 heading assertions pass, excerpt smoke OK |

## Log

- 2026-08-08 — story created by /plan-phase
- 2026-08-08 — branch feat/phase-3-parse-cite created from origin/main; Step 1 done
